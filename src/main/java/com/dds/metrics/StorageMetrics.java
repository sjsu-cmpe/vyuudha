...
public class StorageMetrics {
	...
	private static final CounterMetric QUEUE_DEPTH = Metrics.newCounter(StorageMetrics.class, "queue-depth");
	private static final HistogramMetric DIRECTORY_SIZE = Metrics.newHistogram(StorageMetrics.class, "directory-size", false);
