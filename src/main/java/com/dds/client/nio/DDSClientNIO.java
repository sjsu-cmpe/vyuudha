...
public class DDSClientNIO implements Runnable {
	...
	public DDSClientNIO(InetAddress hostAddress, int port) throws IOException {
	...
	public static void main(String[] args) {
		try {
			DDSClientNIO client = new DDSClientNIO(InetAddress.getByName("localhost"), 9090);
			Thread t = new Thread(client);
			t.setDaemon(true);
			t.start();
			RspHandler handler = new RspHandler();
			client.send(Helper.getBytes("put,key1,value10"), handler);
